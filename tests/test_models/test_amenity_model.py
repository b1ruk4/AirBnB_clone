#!/usr/bin/python3
"""unit testing the amenity model module"""
...
class TestAmenityModel(unittest.TestCase):
    """The TestAmenityModel class for testing the amenity_model"""

    def setUp(self):
        """creating a new object for the class"""
        self.new = models.amenity.Amenity()

    def test_init(self):
        """testing the init function"""
        self.assertIsInstance(self.new, models.amenity.Amenity)
    ...
    def test_dict(self):
        ...
        self.new.name = "My amenity Model"
