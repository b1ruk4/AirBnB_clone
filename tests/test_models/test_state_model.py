#!/usr/bin/python3
"""unit testing the state model module"""
import models.state
...
class TestStateModel(unittest.TestCase):
    """The TestStateModel class for testing the state_model"""

    def setUp(self):
        """creating a new object for the class"""
        self.new = models.state.State()

    def test_init(self):
        """testing the init function"""
        self.assertIsInstance(self.new, models.state.State)
